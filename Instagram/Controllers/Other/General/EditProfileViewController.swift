...
final class EditProfileViewController: UIViewController {
    ...
    private func createTableHeaderView() -> UIView {
        ...
        profilePhotoButton.addTarget(self, action: #selector(didTapProfilePhotoButtron), for: .touchUpInside)
    ...
    // MARK: - Actions
    @objc private func didTapProfilePhotoButtron() {
    ...
    @objc private func diddTapChangeProfilePicture() {
